...
Route::group(['namespace' => 'Frontend', 'middleware' => ['ipcheck', 'check_refer']], function () {
    ...
    Route::get('all-collection', [FrontendController::class, 'all_collection'])->name('all_collection');

    Route::get('review-popup', [FrontendController::class, 'reviewPopup'])->name('review.popup');
    Route::get('ajax-quick-view', [FrontendController::class, 'quickView'])->name('ajax.quick_view');
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'lock', 'check_refer'], 'prefix' => 'admin'], function () {
    ...
    Route::get('products/sort', [ProductController::class, 'product_sort'])->name('products.sort');
    Route::post('update-product-sort', [ProductController::class, 'updateSort'])->name('update-product-sort');
    ...
    Route::get('order/search-variable', [OrderController::class, 'product_variable_search'])->name('admin.product_variable_search');
    ...
    // Route::resource('homepagebuilder', 'HomepageBuilderController');
    Route::get('homepagebuilder', [HomepageBuilderController::class, 'index'])->name('homepagebuilder.index');
    Route::get('homepagebuilder/create', [HomepageBuilderController::class, 'create'])->name('homepagebuilder.create');
    Route::post('homepagebuilder', [HomepageBuilderController::class, 'store'])->name('homepagebuilder.store');
    Route::get('homepagebuilder/{id}/edit', [HomepageBuilderController::class, 'edit'])->name('homepagebuilder.edit');
    Route::put('homepagebuilder/{id}', [HomepageBuilderController::class, 'update'])->name('homepagebuilder.update');
    Route::post('homepagebuilder/reorder', [HomepageBuilderController::class, 'reorder'])->name('homepagebuilder.reorder');
    Route::delete('homepagebuilder/{id}', [HomepageBuilderController::class, 'destroy'])->name('homepagebuilder.destroy');
