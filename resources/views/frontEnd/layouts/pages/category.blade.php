            ...
            <div class="row">
                <div class="col-sm-3 filter_sidebar">
                    ...
                    <form action="" class="attribute-submit">
                       ...
                       {{-- <div class="sidebar_item wraper__item mb-3">
                        ...
                        @if($category->subcategories->count() > 0)
                         <div class="sidebar_item wraper__item  mb-3">
                          <div class="accordion" id="filter_sidebar">
                              <div class="accordion-item">
                                <h2 class="accordion-header">
                                  <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFilter5" aria-expanded="true" aria-controls="collapseOne">
                                   Subcategory
                                  </button>
                                </h2>
                                <div id="collapseFilter5" class="accordion-collapse collapse show" data-bs-parent="#filter_sidebar">
                                  <div class="accordion-body cust_according_body">
                                    <div class="filter-body">
                                        <div class="subcategory-submit">
                                            <ul class="space-y-3 grid__this">
                                              @foreach ($category->subcategories as $subcategory)
                                                <li>
                                                    <label for="{{ $subcategory->slug . '-' . $subcategory->id }}" class="subcategory-filter-label">
                                                        <input class="form-attribute subcat-checkbox" 
                ...
                <div class="col-sm-9">
                @if (count(request()->all()) == 0 && $category->banner_status == 1)
                    <div class="category_banner_sec">
...
@push('script')
    ...
    <script>
        ...
        $(".subcat-checkbox").change(function() {
            $(".subcategory-submit").submit();
        })
