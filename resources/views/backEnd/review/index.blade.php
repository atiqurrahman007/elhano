        ...
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">
                    ...
                    @endphp
                    <a href="{{route('reviews.index')}}" class="btn btn-outline-info rounded-pill">All Reviews</a>
                    <a href="{{route('reviews.pending')}}" class="btn btn-outline-pink rounded-pill">Pending ({{$pending_reviews}})</a>
                </h4>
            </div>
        </div>
    </div>        
