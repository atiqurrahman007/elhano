                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- col end -->
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                    <label for="best_deals_title" class="form-label"> Best Deals Description </label>
                                    <textarea name="best_deals_title" rows="2"
                                        class="form-control @error('best_deals_title') is-invalid @enderror">{{ $edit_data->best_deals_title }}</textarea>
                                    @error('best_deals_title')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    @enderror
                            ...
                            <div class="col-sm-6 mb-3">
                                <div class="form-group">
                                    <label for="fan_favorite" class="form-label">Fan Favorites Description</label>
                                    <textarea name="fan_favorite" rows="2"
                                        class="form-control @error('fan_favorite') is-invalid @enderror">{{ $edit_data->fan_favorite }}</textarea>
                                    @error('fan_favorites')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
