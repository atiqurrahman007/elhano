                    ...
                    <div class="modern-filter-card no-print">
                        ...
                        <form>
                            <div class="row align-items-end">
                                <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                    <div class="form-group mb-0">
                                        ...
                                        <input type="text" value="{{request()->get('keyword')}}" class="form-control"
                                            name="keyword" placeholder="Search customer...">
                                    </div>
                                </div>
                                <!--col-->
                                <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                    <div class="form-group mb-0">
                                        <label for="user_id" class="form-label"><i class="fas fa-user-tie"></i> Assign
                                            User</label>
                                        <select class="form-control select2 @error('user_id') is-invalid @enderror"
                                            name="user_id" value="{{ old('user_id') }}">
                                            <option value="">Select..</option>
                                            @foreach($users as $key => $value)
                                                <option value="{{$value->id}}" @if(request()->get('user_id') == $value->id) selected
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                    <div class="form-group mb-0">
                                        <label for="order_status" class="form-label"><i class="fas fa-info-circle"></i> Order
                                            Status</label>
                                        <select class="form-control select2" name="order_status">
                                            <option value="">All Status</option>
                                            @foreach($statuses as $st)
                                                <option value="{{$st->id}}" @if($status == $st->id) selected @endif>{{$st->name}}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                    <div class="form-group mb-0">
                                        <label for="filter" class="form-label"><i class="fas fa-filter"></i> Quick
                                            Filter</label>
                                        <select class="form-control select2" name="filter" id="filter-select">
                                            <option value="">Choose Period...</option>
                                            <option value="today" @if(request()->get('filter') == 'today') selected @endif>Today
                                            </option>
                                            <option value="yesterday" @if(request()->get('filter') == 'yesterday') selected
                                            @endif>Yesterday</option>
                                            <option value="this_week" @if(request()->get('filter') == 'this_week') selected
                                            @endif>This Week</option>
                                            <option value="last_week" @if(request()->get('filter') == 'last_week') selected
                                            @endif>Last Week</option>
                                            <option value="this_month" @if(request()->get('filter') == 'this_month') selected
                                            @endif>This Month</option>
                                            <option value="last_month" @if(request()->get('filter') == 'last_month') selected
                                            @endif>Last Month</option>
                                            <option value="this_year" @if(request()->get('filter') == 'this_year') selected
                                            @endif>This Year</option>
                                        </select>
                                    </div>
                                </div>
                                <!--col-->
                                ...
                                <div class="col-lg-2 col-md-4 col-sm-6 mb-3">
                                    <div class="form-group mb-0">
                                        <label for="end_date" class="form-label"><i class="fas fa-calendar-alt"></i> End
                                            Date</label>
                                ...
                                <div class="col-sm-12 text-end mt-2 mb-3">
                                    <div class="form-group mb-0">
                                        <button class="btn btn-primary modern-filter-btn rounded-pill px-4 shadow-sm me-2"><i
                                                class="fas fa-search me-1"></i> Filter Report</button>
                                        <a href="{{route('admin.order_report')}}"
                                            class="btn btn-outline-danger rounded-pill px-4"><i class="fas fa-undo me-1"></i>
                                            Reset</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-6">
                            <div class="export-print text-end">
                                <button onclick="printFunction()" class="no-print btn btn-success"><i class="fa fa-print"></i>
                                    Print</button>
                                    ...
                                    <tr>
                                        <td colspan="9" class="text-center">
                                            ...
                                            <h5><strong>Total Profit =
                                                    {{($total_sales - $total_discount) - $total_purchase}}</strong></h5>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
