                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('categories.update') }}" method="POST" class="row"
                            ...
                            <div class="col mb-3">
                                <div class="form-group">
                                    <label for="banner_status" class="d-block">Banner Status</label>
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="banner_status"
                                            @if ($edit_data->banner_status == 1) checked @endif>
                                        <span class="slider round"></span>
                                    </label>
                                    @error('banner_status')
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col mb-3">
                                <div class="form-group">
                                    <label for="highlight" class="d-block">High light</label>
                                    <label class="switch">
                                        <input type="checkbox" value="1" name="highlight"
                                            @if ($edit_data->highlight == 1) checked @endif>
                                        <span class="slider round"></span>
                                    </label>
                                    @error('highlight')
                                        <span class="invalid-feedback" role="alert">
