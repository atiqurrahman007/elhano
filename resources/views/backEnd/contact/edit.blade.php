                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('contact.update') }}" method="POST" class="row" data-parsley-validate=""
                            ...
                            <div class="col-sm-12">
                                <div class="form-group mb-3">
                                    <label for="mesenger" class="form-label">Mesenger Link</label>
                                    <input type="text" class="form-control @error('mesenger') is-invalid @enderror"
                                        name="mesenger" value="{{ $edit_data->mesenger }}" id="mesenger">
                                    @error('mesenger')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
